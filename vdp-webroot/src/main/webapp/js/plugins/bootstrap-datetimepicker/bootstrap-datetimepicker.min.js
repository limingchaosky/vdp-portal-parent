...
w=this.endDate.getUTCMonth()+1,a=(new r(this.date.getUTCFullYear(),this.date.getUTCMonth(),this.date.getUTCDate())).valueOf(),l=new Date;this.setTitle(".datetimepicker-days",b+"\u5e74 "+k[this.language].months[c]);if("time"===this.formatViewType){var m=this.getFormattedDate();this.setTitle(".datetimepicker-hours",m);this.setTitle(".datetimepicker-minutes",m)}else this.setTitle(".datetimepicker-hours",d+" "+k[this.language].months[c]+" "+b),this.setTitle(".datetimepicker-minutes",d+" "+k[this.language].months[c]+
" "+b);this.picker.find("tfoot th.today").text(k[this.language].today||k.en.today).toggle(!1!==this.todayBtn);this.picker.find("tfoot th.clear").text(k[this.language].clear||k.en.clear).toggle(!1!==this.clearBtn);this.updateNavArrows();this.fillMonths();var n=r(b,c-1,28,0,0,0,0),m=f.getDaysInMonth(n.getUTCFullYear(),n.getUTCMonth());n.setUTCDate(m);n.setUTCDate(m-(n.getUTCDay()-this.weekStart+7)%7);var u=new Date(n);u.setUTCDate(u.getUTCDate()+42);for(var u=u.valueOf(),m=[],p;n.valueOf()<u;)n.getUTCDay()===
this.weekStart&&m.push("<tr>"),p=this.onRenderDay(n),n.getUTCFullYear()<b||n.getUTCFullYear()===b&&n.getUTCMonth()<c?p.push("old"):(n.getUTCFullYear()>b||n.getUTCFullYear()===b&&n.getUTCMonth()>c)&&p.push("new"),this.todayHighlight&&n.getUTCFullYear()===l.getFullYear()&&n.getUTCMonth()===l.getMonth()&&n.getUTCDate()===l.getDate()&&p.push("today"),n.valueOf()===a&&p.push("active"),(n.valueOf()+864E5<=this.startDate||n.valueOf()>this.endDate||-1!==e.inArray(n.getUTCDay(),this.daysOfWeekDisabled)||-1!==
e.inArray(n.toDateString(),this.datesDisabled))&&p.push("disabled"),m.push('<td class="'+p.join(" ")+'">'+n.getUTCDate()+"</td>"),n.getUTCDay()===this.weekEnd&&m.push("</tr>"),n.setUTCDate(n.getUTCDate()+1);this.picker.find(".datetimepicker-days tbody").empty().append(m.join(""));for(var m=[],q,n="",u=this.hoursDisabled||[],a=new Date(this.viewDate),l=0;24>l;l++)a.setUTCHours(l),p=this.onRenderHour(a),-1!==u.indexOf(l)&&p.push("disabled"),q=r(b,c,d,l),q.valueOf()+36E5<=this.startDate||q.valueOf()>
this.endDate?p.push("disabled"):h===l&&p.push("active"),this.showMeridian&&2===k[this.language].meridiem.length?(q=12>l?k[this.language].meridiem[0]:k[this.language].meridiem[1],q!==n&&(""!==n&&m.push("</fieldset>"),m.push('<fieldset class="hour"><legend>'+q.toUpperCase()+"</legend>")),n=q,q=l%12?l%12:12,12>l?p.push("hour_am"):p.push("hour_pm"),m.push('<span class="'+p.join(" ")+'">'+q+"</span>"),23===l&&m.push("</fieldset>")):(q=l+":00",m.push('<span class="'+p.join(" ")+'">'+q+"</span>"));this.picker.find(".datetimepicker-hours td").html(m.join(""));
m=[];n="";c=this.minutesDisabled||[];a=new Date(this.viewDate);for(l=0;60>l;l+=this.minuteStep)-1===c.indexOf(l)&&(a.setUTCMinutes(l),a.setUTCSeconds(0),p=this.onRenderMinute(a),this.showMeridian&&2===k[this.language].meridiem.length?(q=12>h?k[this.language].meridiem[0]:k[this.language].meridiem[1],q!==n&&(""!==n&&m.push("</fieldset>"),m.push('<fieldset class="minute"><legend>'+q.toUpperCase()+"</legend>")),n=q,q=h%12?h%12:12,m.push('<span class="'+p.join(" ")+'">'+q+":"+(10>l?"0"+l:l)+"</span>"),
59===l&&m.push("</fieldset>")):m.push('<span class="'+p.join(" ")+'">'+h+":"+(10>l?"0"+l:l)+"</span>"));this.picker.find(".datetimepicker-minutes td").html(m.join(""));h=this.date.getUTCFullYear();c=this.setTitle(".datetimepicker-months",b).end().find(".month").removeClass("active");h===b&&c.eq(this.date.getUTCMonth()).addClass("active");(b<g||b>t)&&c.addClass("disabled");b===g&&c.slice(0,z).addClass("disabled");b===t&&c.slice(w).addClass("disabled");m="";b=10*parseInt(b/10,10);g=this.setTitle(".datetimepicker-years",
b+"-"+(b+9)).end().find("td");--b;a=new Date(this.viewDate);for(l=-1;11>l;l++)a.setUTCFullYear(b),p=this.onRenderYear(a),-1!==l&&10!==l||p.push(x),m+='<span class="'+p.join(" ")+'">'+b+"</span>",b+=1;g.html(m);this.place()}},updateNavArrows:function(){var a=new Date(this.viewDate),b=a.getUTCFullYear(),c=a.getUTCMonth(),d=a.getUTCDate(),a=a.getUTCHours();switch(this.viewMode){case 0:b<=this.startDate.getUTCFullYear()&&c<=this.startDate.getUTCMonth()&&d<=this.startDate.getUTCDate()&&a<=this.startDate.getUTCHours()?
...
":"+this.convertViewModeText(this.viewMode),date:this.viewDate,startDate:this.startDate,endDate:this.endDate});break;case "clear":this.reset();this.autoclose&&this.hide();break;case "today":a=new Date,a=r(a.getFullYear(),a.getMonth(),a.getDate(),a.getHours(),a.getMinutes(),a.getSeconds(),0),a<this.startDate?a=this.startDate:a>this.endDate&&(a=this.endDate),this.viewMode=this.startViewMode,this.showMode(0),this._setDate(a),this.fill(),this.autoclose&&this.hide()}break;case "span":if(!a.is(".disabled")){var b=
this.viewDate.getUTCFullYear(),c=this.viewDate.getUTCMonth(),d=this.viewDate.getUTCDate(),h=this.viewDate.getUTCHours(),g=this.viewDate.getUTCMinutes(),k=this.viewDate.getUTCSeconds();if(a.is(".month"))this.viewDate.setUTCDate(1),c=a.parent().find("span").index(a),d=this.viewDate.getUTCDate(),this.viewDate.setUTCMonth(c),this.element.trigger({type:"changeMonth",date:this.viewDate}),3<=this.viewSelect&&this._setDate(r(b,c,d,h,g,k,0));else if(a.is(".year"))this.viewDate.setUTCDate(1),b=parseInt(a.text(),
10)||0,this.viewDate.setUTCFullYear(b),this.element.trigger({type:"changeYear",date:this.viewDate}),4<=this.viewSelect&&this._setDate(r(b,c,d,h,g,k,0));else if(a.is(".hour")){h=parseInt(a.text(),10)||0;if(a.hasClass("hour_am")||a.hasClass("hour_pm"))12===h&&a.hasClass("hour_am")?h=0:12!==h&&a.hasClass("hour_pm")&&(h+=12);this.viewDate.setUTCHours(h);this.element.trigger({type:"changeHour",date:this.viewDate});1<=this.viewSelect&&this._setDate(r(b,c,d,h,g,k,0))}else a.is(".minute")&&(g=parseInt(a.text().substr(a.text().indexOf(":")+
1),10)||0,this.viewDate.setUTCMinutes(g),this.element.trigger({type:"changeMinute",date:this.viewDate}),0<=this.viewSelect&&this._setDate(r(b,c,d,h,g,k,0)));0!==this.viewMode?(a=this.viewMode,this.showMode(-1),this.fill(),a===this.viewMode&&this.autoclose&&this.hide()):(this.fill(),this.autoclose&&this.hide())}break;case "td":a.is(".day")&&!a.is(".disabled")&&(d=parseInt(a.text(),10)||1,b=this.viewDate.getUTCFullYear(),c=this.viewDate.getUTCMonth(),h=this.viewDate.getUTCHours(),g=this.viewDate.getUTCMinutes(),
k=this.viewDate.getUTCSeconds(),a.is(".old")?0===c?(c=11,--b):--c:a.is(".new")&&(11===c?(c=0,b+=1):c+=1),this.viewDate.setUTCFullYear(b),this.viewDate.setUTCMonth(c,d),this.element.trigger({type:"changeDay",date:this.viewDate}),2<=this.viewSelect&&this._setDate(r(b,c,d,h,g,k,0))),a=this.viewMode,this.showMode(-1),this.fill(),a===this.viewMode&&this.autoclose&&this.hide()}},_setDate:function(a,b){b&&"date"!==b||(this.date=a);b&&"view"!==b||(this.viewDate=a);this.fill();this.setValue();var c;this.isInput?
c=this.element:this.component&&(c=this.element.find("input"));c&&c.change();this.element.trigger({type:"changeDate",date:this.getDate()});null===a&&(this.date=this.viewDate)},moveMinute:function(a,b){if(!b)return a;a=new Date(a.valueOf());a.setUTCMinutes(a.getUTCMinutes()+b*this.minuteStep);return a},moveHour:function(a,b){if(!b)return a;a=new Date(a.valueOf());a.setUTCHours(a.getUTCHours()+b);return a},moveDate:function(a,b){if(!b)return a;a=new Date(a.valueOf());a.setUTCDate(a.getUTCDate()+b);return a},
moveMonth:function(a,b){if(!b)return a;var c=new Date(a.valueOf());a=c.getUTCDate();var d=c.getUTCMonth(),e=Math.abs(b),g;b=0<b?1:-1;if(1===e){if(e=-1===b?function(){return c.getUTCMonth()===d}:function(){return c.getUTCMonth()!==g},g=d+b,c.setUTCMonth(g),0>g||11<g)g=(g+12)%12}else{for(var f=0;f<e;f++)c=this.moveMonth(c,b);g=c.getUTCMonth();c.setUTCDate(a);e=function(){return g!==c.getUTCMonth()}}for(;e();)c.setUTCDate(--a),c.setUTCMonth(g);return c},moveYear:function(a,b){return this.moveMonth(a,
12*b)},dateWithinRange:function(a){return a>=this.startDate&&a<=this.endDate},keydown:function(a){if(this.picker.is(":not(:visible)"))27===a.keyCode&&this.show();else{var b=!1,c,d,e;switch(a.keyCode){case 27:this.hide();a.preventDefault();break;case 37:case 39:if(!this.keyboardNavigation)break;c=37===a.keyCode?-1:1;var g=this.viewMode;a.ctrlKey?g+=2:a.shiftKey&&(g+=1);4===g?(d=this.moveYear(this.date,c),e=this.moveYear(this.viewDate,c)):3===g?(d=this.moveMonth(this.date,c),e=this.moveMonth(this.viewDate,
c)):2===g?(d=this.moveDate(this.date,c),e=this.moveDate(this.viewDate,c)):1===g?(d=this.moveHour(this.date,c),e=this.moveHour(this.viewDate,c)):0===g&&(d=this.moveMinute(this.date,c),e=this.moveMinute(this.viewDate,c));this.dateWithinRange(d)&&(this.date=d,this.viewDate=e,this.setValue(),this.update(),a.preventDefault(),b=!0);break;case 38:case 40:if(!this.keyboardNavigation)break;c=38===a.keyCode?-1:1;g=this.viewMode;a.ctrlKey?g+=2:a.shiftKey&&(g+=1);4===g?(d=this.moveYear(this.date,c),e=this.moveYear(this.viewDate,
c)):3===g?(d=this.moveMonth(this.date,c),e=this.moveMonth(this.viewDate,c)):2===g?(d=this.moveDate(this.date,7*c),e=this.moveDate(this.viewDate,7*c)):1===g?this.showMeridian?(d=this.moveHour(this.date,6*c),e=this.moveHour(this.viewDate,6*c)):(d=this.moveHour(this.date,4*c),e=this.moveHour(this.viewDate,4*c)):0===g&&(d=this.moveMinute(this.date,4*c),e=this.moveMinute(this.viewDate,4*c));this.dateWithinRange(d)&&(this.date=d,this.viewDate=e,this.setValue(),this.update(),a.preventDefault(),b=!0);break;
...
1);return a},d:function(a,b){return a.setUTCDate(b)},p:function(a,b){return a.setUTCHours(1===b?a.getUTCHours()+12:a.getUTCHours())},z:function(){return f}},m;l.M=l.MM=l.mm=l.m;l.dd=l.d;l.P=l.p;l.Z=l.z;a=r(a.getFullYear(),a.getMonth(),a.getDate(),a.getHours(),a.getMinutes(),a.getSeconds());if(g.length===b.parts.length){for(var h=0,n=b.parts.length;h<n;h++){m=parseInt(g[h],10);d=b.parts[h];if(isNaN(m))switch(d){case "MM":m=e(k[c].months).filter(function(){var a=this.slice(0,g[h].length),b=g[h].slice(0,
a.length);return a===b});m=e.inArray(m[0],k[c].months)+1;break;case "M":m=e(k[c].monthsShort).filter(function(){var a=this.slice(0,g[h].length),b=g[h].slice(0,a.length);return a.toLowerCase()===b.toLowerCase()});m=e.inArray(m[0],k[c].monthsShort)+1;break;case "p":case "P":m=e.inArray(g[h].toLowerCase(),k[c].meridiem);break;case "z":case "Z":f}v[d]=m}for(h=0;h<w.length;h++)if(d=w[h],d in v&&!isNaN(v[d]))l[d](a,v[d])}return a},formatDate:function(a,b,c,d,h){if(null===a)return"";if("standard"===d)d=
{t:a.getTime(),yy:a.getUTCFullYear().toString().substring(2),yyyy:a.getUTCFullYear(),m:a.getUTCMonth()+1,M:k[c].monthsShort[a.getUTCMonth()],MM:k[c].months[a.getUTCMonth()],d:a.getUTCDate(),D:k[c].daysShort[a.getUTCDay()],DD:k[c].days[a.getUTCDay()],p:2===k[c].meridiem.length?k[c].meridiem[12>a.getUTCHours()?0:1]:"",h:a.getUTCHours(),i:a.getUTCMinutes(),s:a.getUTCSeconds(),z:h},d.H=2===k[c].meridiem.length?0===d.h%12?12:d.h%12:d.h,d.HH=(10>d.H?"0":"")+d.H,d.P=d.p.toUpperCase(),d.Z=d.z,d.hh=(10>d.h?
"0":"")+d.h,d.ii=(10>d.i?"0":"")+d.i,d.ss=(10>d.s?"0":"")+d.s,d.dd=(10>d.d?"0":"")+d.d,d.mm=(10>d.m?"0":"")+d.m;else if("php"===d)d={y:a.getUTCFullYear().toString().substring(2),Y:a.getUTCFullYear(),F:k[c].months[a.getUTCMonth()],M:k[c].monthsShort[a.getUTCMonth()],n:a.getUTCMonth()+1,t:f.getDaysInMonth(a.getUTCFullYear(),a.getUTCMonth()),j:a.getUTCDate(),l:k[c].days[a.getUTCDay()],D:k[c].daysShort[a.getUTCDay()],w:a.getUTCDay(),N:0===a.getUTCDay()?7:a.getUTCDay(),S:a.getUTCDate()%10<=k[c].suffix.length?
k[c].suffix[a.getUTCDate()%10-1]:"",a:2===k[c].meridiem.length?k[c].meridiem[12>a.getUTCHours()?0:1]:"",g:0===a.getUTCHours()%12?12:a.getUTCHours()%12,G:a.getUTCHours(),i:a.getUTCMinutes(),s:a.getUTCSeconds()},d.m=(10>d.n?"0":"")+d.n,d.d=(10>d.j?"0":"")+d.j,d.A=d.a.toString().toUpperCase(),d.h=(10>d.g?"0":"")+d.g,d.H=(10>d.G?"0":"")+d.G,d.i=(10>d.i?"0":"")+d.i,d.s=(10>d.s?"0":"")+d.s;else throw Error("Invalid format type.");a=[];c=e.extend([],b.separators);h=0;for(var g=b.parts.length;h<g;h++)c.length&&
...
function(){e.fn.datetimepicker=x;return this};e(document).on("focus.datetimepicker.data-api click.datetimepicker.data-api",'[data-provide="datetimepicker"]',function(a){var b=e(this);b.data("datetimepicker")||(a.preventDefault(),b.datetimepicker("show"))});e(function(){e('[data-provide="datetimepicker-inline"]').datetimepicker()})});
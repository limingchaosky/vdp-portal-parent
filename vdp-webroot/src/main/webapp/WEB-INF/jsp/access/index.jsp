...
<script id="accessTem" type="text/html">
    <form>
        ...
        <div class="item-row padding-xs">
            <label class="wind-label">Mac地址</label>
            <input class="wind-input requierd" type="text" value="{{$data.nacMac}}" name="nacMac" placeholder="例如：FF:FF:FF:FF:FF:FF">
            <span class="error-text"></span>
        </div>
        <div class="item-row padding-xs">
            <label class="wind-label">跳转地址</label>
            <input class="wind-input requierd" type="text" value="{{$data.nacUrl}}" name="nacUrl" placeholder="例如：http://www.neiwang.cn">
            <span class="error-text"></span>
        </div>
        <div class="item-row padding-xs">
            <span class="mustlabel none">*</span>

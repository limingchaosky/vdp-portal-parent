    ...
    <form action="">
        <div class="screenWater">
            ...
            <div class="policy-con">
                ...
                <label for="">
                    ...
                    <input type="text" name="screendiyWaterContent" placeholder="自定义水印内容" value="{{$data.content}}"/>
                </label>
            </div>
        </div>
        <div class="fileOut">
            ...
            <div class="policy-con">
                ...
                <label for="" class="out">
                    <div class="beauty-checkbox">
                        <input id="isScreenWater" name="isScreenWater" type="checkbox" class="j-check-device-all" value="1">
            ...
            <div class="policy-con">
                ...
                <div class="waterShowContent">
                    ...
                    <label for="">
                        ...
                        <input type="text" name="outdiyWaterContent" placeholder="自定义水印内容"/>
                    </label>
                </div>
            </div>
        </div>
        <div class="fileExport">
            ...
            <div class="policy-con">
                ...
                <label for="" class="export">
                    <div class="beauty-checkbox">
                        <input id="isScreen" name="isScreen" type="checkbox" class="j-check-device-all" value="1">
                ...
                <div class="waterShowContent">
                    ...
                    <label for="">
                        ...
                        <input type="text" name="exportdiyWaterContent" placeholder="自定义水印内容"/>
                    </label>
                </div>
            </div>
        </div>
